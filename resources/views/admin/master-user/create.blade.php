        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 font-medium mt-1">
                    Tambah user dengan role Admin atau Petugas. Petugas dapat login dengan menu sama seperti admin kecuali Master dan Pelatihan.
                </p>
            </div>
        ...
        <x-card>
            <form action="{{ route('master-user.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <x-input label="Nama" name="name" placeholder="Nama lengkap" value="{{ old('name') }}" required />
                    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <x-input label="Email" name="email" type="email" placeholder="email@contoh.com" value="{{ old('email') }}" required />
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
